...
describe('validatePattern', () => {
  describe('valid patterns', () => {
    ...
    it('should accept patterns with wildcards', () => {
  ...
  describe('SQL injection attempts', () => {
    it('should reject patterns with semicolons', () => {
      expect(() => validatePattern('test;DROP')).toThrow(/Invalid pattern/);
    });

    it('should reject patterns with single quotes', () => {
    ...
    it('should reject patterns with double dashes', () => {
      expect(() => validatePattern('test--comment')).toThrow(/Invalid pattern/);
    });

    it('should reject patterns with SQL keywords', () => {
      expect(() => validatePattern('test DROP')).toThrow(/Invalid pattern/);
  ...
  describe('edge cases', () => {
    ...
    it('should reject patterns longer than 63 characters', () => {
    ...
    it('should accept patterns exactly 63 characters', () => {
      const maxPattern = 'a'.repeat(63);
      expect(() => validatePattern(maxPattern)).not.toThrow();
    });

    it('should reject non-string inputs', () => {
      expect(() => validatePattern(123 as any)).toThrow(/must be a string/);
      expect(() => validatePattern(null as any)).toThrow(/must be a string/);
      expect(() => validatePattern(undefined as any)).toThrow(
        /must be a string/,
      );
      expect(() => validatePattern({} as any)).toThrow(/must be a string/);
    });
  });
});
...
describe('validateIdentifier', () => {
  describe('valid identifiers', () => {
    ...
    it('should accept complex valid identifiers', () => {
      expect(() => validateIdentifier('my_schema_v2', 'schema')).not.toThrow();
  ...
  describe('SQL injection attempts', () => {
    ...
    it('should reject identifiers with single quotes', () => {
    ...
    it('should reject identifiers with double dashes', () => {
  ...
  describe('SQL keywords', () => {
    it('should reject common SQL keywords', () => {
  ...
  describe('invalid start characters', () => {
    ...
    it('should reject identifiers starting with dollar signs', () => {
  ...
  describe('edge cases', () => {
    ...
    it('should accept identifiers exactly 63 characters', () => {
      const maxId = 'a'.repeat(63);
      expect(() => validateIdentifier(maxId, 'schema')).not.toThrow();
    });

    it('should reject non-string inputs', () => {
      expect(() => validateIdentifier(123 as any, 'schema')).toThrow(
        /must be a string/,
      );
      expect(() => validateIdentifier(null as any, 'schema')).toThrow(
        /must be a string/,
      );
      expect(() => validateIdentifier(undefined as any, 'schema')).toThrow(
        /must be a string/,
      );
    });
...
describe('validatePatterns', () => {
  describe('valid pattern arrays', () => {
    ...
    it('should accept single valid pattern', () => {
  ...
  describe('invalid pattern arrays', () => {
    ...
    it('should indicate which pattern failed', () => {
    ...
    it('should reject non-array inputs', () => {
      expect(() => validatePatterns('not_an_array' as any)).toThrow(
        /must be an array/,
      );
      expect(() => validatePatterns(null as any)).toThrow(/must be an array/);
      expect(() => validatePatterns(123 as any)).toThrow(/must be an array/);
    });
  });
});
...
describe('validateRoles', () => {
  ...
  describe('invalid role arrays', () => {
    it('should reject empty role arrays', () => {
      expect(() => validateRoles([])).toThrow(/cannot be empty/);
    });

    it('should reject arrays with invalid roles', () => {
      expect(() => validateRoles(['anon', "'; DROP"])).toThrow(
        /Invalid role at index 1/,
      );
      expect(() => validateRoles(['authenticated', 'test;DROP ROLE'])).toThrow(
        /Invalid role at index 1/,
      );
    });

    it('should indicate which role failed', () => {
      expect(() => validateRoles(['anon', 'authenticated', "'; DROP"])).toThrow(
        /index 2/,
      );
    ...
    it('should reject non-array inputs', () => {
      expect(() => validateRoles('not_an_array' as any)).toThrow(
        /must be an array/,
      );
      expect(() => validateRoles(null as any)).toThrow(/must be an array/);
      expect(() => validateRoles(123 as any)).toThrow(/must be an array/);
    });
  });
});
