...
import { getRLSStatus, printStatus } from '../../src/core/status-rls.js';
...
describe('getRLSStatus - Input Validation', () => {
...
describe('getRLSStatus - Success Cases', () => {
  const mockConnectionString = 'postgresql://user:pass@localhost:5432/db';
  ...
  it('should successfully get RLS status for tables', async () => {
  ...
  it('should handle custom schema parameter', async () => {
    const mockQueryResult = {
      rows: [
        { tablename: 'custom_table', rowsecurity: true },
      ],
    };
...
describe('printStatus', () => {
  ...
  it('should print RLS status header', () => {
    const result = {
      tables: [
        { tablename: 'users', rowsecurity: true },
      ],
  ...
  it('should print table data with console.table', () => {
    const result = {
      tables: [
        { tablename: 'users', rowsecurity: true },
