...
export type Page =
  | {
      ...
      block?: (HeadingBlock | TextBlock | RichTextBlock | ButtonBlock | SliderBlock)[] | null;
      id?: string | null;
    }[]
  | null;
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "PostSlider".
 */
...
export interface Config {
  ...
  fallbackLocale: ('false' | 'none' | 'null') | false | null | 'ja' | 'ja'[];
  globals: {};
  globalsSelect: {};
  locale: 'ja';
  user: User & {
...
export interface ButtonBlock {
  url: string;
  /**
   * 未入力の場合、デフォルト値 "Learn More" が適用されます。
   */
  label?: string | null;
  id?: string | null;
  blockName?: string | null;
...
export interface PageSelect<T extends boolean = true> {
  ...
  block?:
    | T
    | {
        Heading2?: T | HeadingBlockSelect<T>;
...
export interface SliderBlockSelect<T extends boolean = true> {
  slider?: T | PostSliderSelect<T>;
  id?: T;
  blockName?: T;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "PostSlider_select".
 */
export interface PostSliderSelect<T extends boolean = true> {
  image?: T;
  caption?: T;
  id?: T;
}
